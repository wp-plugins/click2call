...
Version: v1
Author: LigFlat Telecom
Author URI: http://www.ligflat.com.br
*/
...
class WP_Click2Call {
    ...
    static function admin_menu() {
        ...
        global $submenu;
        if (is_array($submenu) && !isset($submenu['ligflat'])) {
            $submenu['ligflat'] = array();
        }
    }
    ...
    {
        self::$c2c->config = array_merge(self::$c2c->config, $atts);
        return self::$c2c->button();
    }
